...
const fightPockets = [
	...
	['lobsterfrogman', 		'War Quest', 220, '/images/adventureimages/lobsterman.gif'],
	['Green Ops Soldier', 		'Smoke bomb, olfact', 589, '/images/adventureimages/warhipgr.gif'],
	['War Hippy (space) cadet', 	'YR for outfit', 443, '/images/adventureimages/warhipb.gif'],
	['War Pledge', 			'YR for outfit', 568, '/images/adventureimages/fratboy.gif'],
];
...
const bellPockets = [
	...
	['Frost-rimed desk bell', 	'Cold Wad', 587, '/images/adventureimages/ccs_herald.gif'],
...
const itemPockets = [
	...
	['Handful of drink tickets', 	'2-5 random booze', 	350, '/images/itemimages/dtickets.gif'],
];
